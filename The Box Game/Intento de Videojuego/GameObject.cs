...
{
    public partial class GameObject : PictureBox
    {
        ...
        public bool EsEstatico { get => esEstatico; set => esEstatico = value; }
        public bool EsFisico { get => esFisico; set => esFisico = value; }
        public int VelocidadHorizontal { get => velocidadHorizontal; set => velocidadHorizontal = value; }
        ...
        public int TiempoDeCaida { get => tiempoDeCaida; set => tiempoDeCaida = value; }
        public bool AfectaGravedad { get => afectaGravedad; set => afectaGravedad = value; }
        #endregion
